...
*/
   ...
   /* Lectura Instalacion */
   if(!risnull(CDOUBLETYPE, (char *) &regMod.lecturaInstalacion)){
		sprintf(sLinea, "%s\"%.0f\";", sLinea, regMod.lecturaInstalacion);
	}else{
		strcat(sLinea, "\"\";");
	}
		
   /* Lectura Retiro */
   if(!risnull(CDOUBLETYPE, (char *) &regMod.lecturaRetiro)){
		sprintf(sLinea, "%s\"%.0f\";", sLinea, regMod.lecturaRetiro);
	}else{
		strcat(sLinea, "\"\";");
	}
