...
$ClsClientes	*regClie;
{
   ...
   memset(regClie->tip_doc_SF, '\0', sizeof(regClie->tip_doc_SF));
	...
	memset(regClie->sClienteDigital, '\0', sizeof(regClie->sClienteDigital));
...
*/
   ...
   if(regCliente.sClienteDigital[0]=='S'){
...
$ClsClientes	*regCli;
{
	strcpy(regCli->sClienteDigital, "N");
	...
	if(SQLCODE != 0){
		...
		strcpy(regCli->sClienteDigital, "S");
	}
