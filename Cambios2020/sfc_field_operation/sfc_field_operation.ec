...
int            index;
{
   ...
   switch(sTipo[0]){
      case 'C':
         ...
         /* Estado */
         alltrim(regCor.accion_corte, ' ');
		 if(strcmp(regCor.accion_corte, "66") == 0 ||
			strcmp(regCor.accion_corte, "84") == 0 ||
			strcmp(regCor.accion_corte, "85") == 0 ||
			strcmp(regCor.accion_corte, "80") == 0 ||
			strcmp(regCor.accion_corte, "40") == 0 ||
			strcmp(regCor.accion_corte, "41") == 0 ){
