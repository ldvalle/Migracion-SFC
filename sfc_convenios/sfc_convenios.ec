...
strcpy(sPathSalida, "/home/ldvalle/noti_rep/");
   ...
   sprintf( sArchivoDos  , "%sT1CONVENIOS.csv", sPathSalida );
...
$char sClave[7];
   ...
   sprintf(sCommand, "unix2dos %s > %s", sArchivoUnx, sArchivoAux);
	iRcv=system(sCommand);
...
$ClsConve		reg;
{
   ...
   /* Deuda inicial */
   sprintf(sLinea, "%s\"%.02f\";", sLinea, reg.deuda_origen);
   /* Pie */
   sprintf(sLinea, "%s\"%.02f\";", sLinea, reg.valor_cuota_ini);
   /* Deuda pendiente */
   sprintf(sLinea, "%s\"%.02f\";", sLinea, reg.deuda_convenida);   
   /* Valor cuota */
   sprintf(sLinea, "%s\"%.02f\";", sLinea, reg.valor_cuota);
   /* Valor última cuota */
   sprintf(sLinea, "%s\"%.02f\";", sLinea, reg.valor_cuota);
   /* Total de cuotas */
   ...
   /* Tasa */
   sprintf(sLinea, "%s\"%.02f\";", sLinea, reg.intereses);
   /* Contacto */
